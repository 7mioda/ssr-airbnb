...
var resolvers = {
  Mutation: {
    openModal: function openModal(_, _ref, _ref2) {
      ...
      var _cache$readQuery = cache.readQuery({
        query: query
          ...
          modalStatus = _cache$readQuery.modalStatus;

      cache.writeData({
        data: {
          modalStatus: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, modalStatus, {
            modalName: modalName
          })
        }
      });
    ...
    toggleMenu: function toggleMenu(_, _ref3, _ref4) {
      var dropDown = _ref3.dropDown;
      var cache = _ref4.cache;
      var query = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject2());

      var _cache$readQuery2 = cache.readQuery({
        query: query
      }),
          menuStatus = _cache$readQuery2.menuStatus;

      var toPersist = menuStatus.dropDown === dropDown ? 'none' : dropDown;
      cache.writeData({
        data: {
          menuStatus: {
    ...
    setRoomsPositions: function setRoomsPositions(_, _ref5, _ref6) {
      var roomsMarkers = _ref5.roomsMarkers;
    ...
    changeHoveredRoom: function changeHoveredRoom(_, _ref7, _ref8) {
      var hoveredRoom = _ref7.hoveredRoom;
      var cache = _ref8.cache;
      var data = {
        hoveredRoom: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, hoveredRoom)
      };
      cache.writeData({
        data: data
      });
    ...
    toggleUserStatus: function toggleUserStatus(_, __, _ref9) {
      var cache = _ref9.cache;
      var query = graphql_tag__WEBPACK_IMPORTED_MODULE_2___default()(_templateObject3());

      var _cache$readQuery3 = cache.readQuery({
        query: query
      }),
          userStatus = _cache$readQuery3.userStatus;

      var data = {
        userStatus: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, userStatus, {
    ...
    setConnectedUserInfo: function setConnectedUserInfo(_, _ref10, _ref11) {
      var userInfo = _ref10.userInfo;
      var cache = _ref11.cache;
      var data = {
        connectedUser: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, userInfo)
      };
      cache.writeData({
        data: data
      });
...
/* harmony import */ var _graphql_client_resolvers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../graphql/client/resolvers */ "./graphql/client/resolvers.js");
...
function create(initialState) {
  ...
  var typeDefs = graphql_tag__WEBPACK_IMPORTED_MODULE_5___default()(_templateObject());
  cache.writeData({
    data: {
      connectedUser: {
  ...
  return new apollo_client__WEBPACK_IMPORTED_MODULE_1___default.a({
    connectToDevTools: false,
    ssrMode: !false,
    cache: cache,
    link: apollo_link__WEBPACK_IMPORTED_MODULE_4__["ApolloLink"].from([Object(apollo_link_http__WEBPACK_IMPORTED_MODULE_3__["createHttpLink"])({
      uri: 'http://localhost:4000/graphql'
    })]),
    typeDefs: typeDefs,
    resolvers: _graphql_client_resolvers__WEBPACK_IMPORTED_MODULE_7__["default"]
  });
}
...
/* harmony import */ var _lib_with_apollo_client__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../lib/with-apollo-client */ "./lib/with-apollo-client.js");
...
function (_App) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MyApp, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(next_app__WEBPACK_IMPORTED_MODULE_5__["Container"], null, react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_7__["ApolloProvider"], {
        client: apolloClient
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_lib_with_apollo_client__WEBPACK_IMPORTED_MODULE_8__["default"])(MyApp));
